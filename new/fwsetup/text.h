...
#define NO_TABLE_TITLE _("No Partition Table")
#define NO_TABLE_TEXT _("None of the disk drives have a partition table.\nYou must have at least one disk drive with a partition table.\n")
#define NO_GPT_BIOS_TITLE _("No GPT BIOS Partition")
#define NO_GPT_BIOS_TEXT _("At least one of your GPT partition tables lacks a BIOS partition.\nYou must have one to be able to boot with GRUB in BIOS mode.\nDo you wish to proceed without one?\n")
