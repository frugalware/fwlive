...
#define FORMAT_PATH_TITLE _("Invalid Mount Path")
#define FORMAT_PATH_TEXT _("The mount path you have provided is invalid.\nIt must be prefixed with a '/'.\nIt must also not already be in use.\n")
...
#define NO_SWAP_TEXT _("No Swap Device")
#define NO_SWAP_TITLE _("You have no devices marked for usage as 'swap'.\nIt is recommended that you have at least one.\nDo you wish to proceed without swap?\n")
